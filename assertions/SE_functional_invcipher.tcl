...
elaborate -top SE -bbox_a 16384 -bbox_m CompressionFunction -bbox_m SEOperation -bbox_m Sha256Accel -bbox_m AESDecrypt -bbox_m AESDecrypt_1 -bbox_m AESMAC -bbox_m AESEncrypt384 -bbox_m MaxPeriodFibonacciLFSR 
...
# These two events must not happen before seoperation, otherwise they will cause spurious cex
assume {se_finish==aes_invcipher_op1_start}
assume {aes_cipher_io_input_valid==aes_invcipher_op1_start}
