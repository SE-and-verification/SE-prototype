...
analyze -sva assertions/SE_functional_MAC_ow.sv assertions/fifo.sv
...
# Encryption must not happen before mac finishes, otherwise they will cause spurious cex
assume {aes_cipher_io_input_valid==aes_cipher_for_op1_mac_validation_finish}

# set stop to 1 in an arbitrary cycle
stopat stop_enable

assert -disable *
assert -enable *se_check_mac*
