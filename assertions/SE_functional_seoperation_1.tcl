...
elaborate -top SE -bbox_a 16384 -bbox_i aes_invcipher_op2 -bbox_m SEOperation -bbox_m Sha256Accel -bbox_m AESMAC -bbox_m AESEncrypt384 -bbox_m MaxPeriodFibonacciLFSR 
...
assume {se_finish==seoperation_start}
assume {aes_cipher_io_input_valid==seoperation_start}
