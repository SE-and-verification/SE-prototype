...
elaborate -top SE -bbox_a 16384 -bbox_m CompressionFunction -bbox_m Sha256Accel -bbox_m seoperation -bbox_m AESMAC -bbox_m AESEncrypt384 -bbox_m MaxPeriodFibonacciLFSR 
...
assume {se_finish==seoperation_finish}
assume {aes_cipher_io_input_valid==seoperation_finish}
