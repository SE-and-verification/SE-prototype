...
class SEChangeKey(implicit debug:Boolean) extends Module{
	// Define the input, output ports and the control bits
	...
	*/
	...
	seoperation.io.op1_input := Mux(mid_inst_buffer(7,5) === 5.U(3.W), mid_op1_buffer(127,64),op1_asUInt(127,64))
